...
class ResponseCode {
  ...
  Response get response =>
      Response.json(statusCode: httpCode, body: {'code': internalCode, 'message': message});

  ResponseCode copyWith({final int? httpCode, final String? internalCode, final String? message}) =>
      ResponseCode(
